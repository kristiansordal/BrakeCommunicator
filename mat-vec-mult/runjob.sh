...
#SBATCH -o results/node${nodes}/c${cores}/${job_to_run}.txt
#SBATCH --open-mode=append
#SBATCH --exclusive

module load openmpi-4.0.5
srun build/debug/${job_to_run}_mult_total
"
...
module load openmpi-4.0.5
srun build/debug/${job_to_run}_mult
"

# Save the job script to a temporary file
job_script_file="job_script_temp.sh"
